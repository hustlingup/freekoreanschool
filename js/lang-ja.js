/* ═══════════════════════════════════════════════════════
   한국어 학교 — Japanese Language Pack
   Extracted from app.js. Load this BEFORE app.js.
═══════════════════════════════════════════════════════ */
...
const LangManager = (() => {
  ...
  const JA = {
    ...
    '📰 · Korean News · 한국 뉴스': '📰 · 韓国ニュース · 한국 뉴스',
    'TODAY\'S KOREA · 오늘의 한국': '今日の韓国 · 오늘의 한국',
    'All 전체': '全て 전체', 'LATEST · 최신 기사': '最新記事 · 최신 기사',
    'FEATURED · 주목 기사': '注目記事 · 주목 기사', 'ARTICLES · 기사 목록': '記事一覧 · 기사 목록',
    'Today\'s Korean News': '今日の韓国ニュース', 'Admin ⚙️': '管理 ⚙️',
    '더 보기 — Load More': 'もっと見る',
    'THIS WEEK\'S TOP STORIES · 이번 주 인기 뉴스': '今週のトップ記事 · 이번 주 인기 뉴스',
    'Most Read This Week': '今週最も読まれた記事',
    'VOCABULARY SPOTLIGHT · 핵심 어휘': '語彙スポットライト · 핵심 어휘',
    'Key News Vocabulary': 'ニュース重要語彙', 'Full Vocabulary Lists →': '語彙リストをすべて見る →',
    ...
    'Korean News · 뉴스': '韓国語ニュース · 뉴스', 'Korean Food · 음식': '韓国料理 · 음식',
    ...
    'Reading Short Texts & News': '短いテキストとニュースの読解',
    ...
    'News Reading & Opinion Writing': 'ニュース読解と意見文作成',
    ...
    'These news articles are created by AI for Korean language learning purposes only. Content may be inaccurate or hallucinated — AI makes mistakes. If you want to read real news, search in Korean using what you\'ve learned here:': 'これらのニュース記事は韓国語学習を目的としてAIが生成したものです。内容が不正確またはハルシネーション（AIの誤り）を含む場合があります。本物のニュースを読みたい場合は、このサイトで学んだ韓国語を使って検索してみてください：',
    'Naver News': 'Naver ニュース',
    'AI-generated bilingual news from South Korea, published every morning at 8AM KST. Read at your level — Beginner to Advanced — and learn Korean naturally.': '毎朝8時KSTに公開されるAI生成の韓国バイリンガルニュース。初級から上級まで自分のレベルで読んで、自然に韓国語を学びましょう。',
    '10 essential Korean words that appear most in Korea\'s daily news.': '韓国の日常ニュースに最も頻繁に登場する10の必須韓国語。',
    'Search news…': 'ニュースを検索…',
    '💻 Tech': '💻 テック',
    '🍜 Food': '🍜 フード',
    '⚽ Sports': '⚽ スポーツ',
    ...
    '📰 News & Society (뉴스와 사회)': '📰 ニュースと社会 (뉴스와 사회)',
  ...
  'News anchors, military, first meeting with seniors, formal presentations, customer service scripts': 'ニュースキャスター・軍・初めての目上の方との面会・公式プレゼン・カスタマーサービス',
  ...
  'Written text, novels, newspapers, commands, song lyrics, formal written instructions': '書き言葉・小説・新聞・命令・歌詞・公式な書面指示',
  ...
  '합쇼체 is the most formal speech level in everyday use. It conveys maximum respect and professionalism. You will hear it constantly on Korean news broadcasts, in corporate settings, in the military, and when meeting someone of significantly higher status for the first time.': '합쇼체は日常使いの中で最もフォーマルな敬語レベルです。最大限の敬意と専門性を伝えます。韓국のニュース放送・企業環境・軍・初めてはるかに地位の高い人と会うときに使われます。',
  'Key endings:': '主要な語尾：',
  ...
  'Use 합쇼체 in: news broadcasts and weather reports, military commands and briefings, formal business presentations, meeting someone\'s parents or bosses for the first time, public announcements (airports, subway), customer service scripts in banks and government offices.': '합쇼체を使う場面：ニュース放送と天気予報・軍の命令・公式プレゼン・相手の親や上司との初対面・公共アナウンス（空港・地下鉄）・銀행や行政機関のカスタマーサービス。',
  ...
  '🎓 Dialogue 1 — Good News About University Admission': '🎓 会話1 — 大学合格の嬉しい知らせ',
  ...
  'Proverbs appear in K-dramas, news, and everyday conversation. When a Korean grandparent or mentor says 고생 끝에 낙이 온다, they are offering deep encouragement. Understanding this shows genuine cultural appreciation.': 'ことわざはK-ドラマ・ニュース・日常会話に登場します。韓国の祖父母や師が고생 끝에 낙이 온다と言うとき、深い励ましを贈っています。これを理解することは、本物の文化的な感謝を示します。',
  ...
  'News & Society in Korean': '韓国語のニュース・社会',
  'Understanding Korean news and social vocabulary allows you to engage with current events, read Korean news websites, and have deeper conversations about society. Korean news uses formal language (공식어) and often includes Sino-Korean vocabulary (한자어) which sounds more formal and precise.': '韓国のニュースや社会語彙を理解することで、時事問題に参加し、韓国のニュースサイトを読み、社会についてより深い会話ができます。韓国語のニュースは公式語（공식어）を使用し、より正式で正確に聞こえる漢韓国語語彙（한자어）を多く含みます。',
  'Key news sources': '主要なニュースソース',
  'Major Korean news outlets: 조선일보, 중앙일보 (conservative), 한겨레 (progressive), YTN (cable news). Reading Korean news headlines, even partially, builds vocabulary quickly. Start with entertainment news — easier vocabulary and more engaging!': '주요 한국 뉴스 매체：조선일보・중앙일보（保守系）・한겨레（進歩系）・YTN（ケーブルニュース）。韓国語のニュース見出しを読む、たとえ部分的でも、語彙を素早く増やせます。エンターテインメントニュースから始めましょう。',
  ...
  'International · I read international news': '国際 · 国際ニュースを読みます',
  "Which word means 'election'?": '「選挙」を意味する語はどれですか？',
  '정치 (politics)': '정치（政治）',
  '정부 (government)': '정부（政府）',
  '선거 (election)': '선거（選挙）',
  '법 (law)': '법（法律）',
  'News & Society Complete!': 'ニュース・社会完成！',
  'You can now follow Korean news and social discussions! These words appear constantly in Korean media. Try reading one Korean news headline per day — even if you only understand a few words, it builds momentum.': '韓国のニュースや社会的議論を追えるようになりました！これらの語は韓国のメディアに常時登場します。1日に韓国語のニュース見出しを一つ読んでみましょう — 数語しか理解できなくても、勢いが付きます。',
  ...
  function _renderBtn(lang) {
    ...
    if (!btn) return;
    if (lang === 'ja') btn.textContent = '🇯🇵 日本語';
    else if (lang === 'zh-tw') btn.textContent = '🇹🇼 繁體中文';
    ...
    if (!document.getElementById('lang-dropdown')) {
      ...
      dd.id = 'lang-dropdown';
      dd.innerHTML = `
        <button class="lang-dropdown-item${lang === 'en' ? ' active' : ''}" onclick="LangManager.setLang('en')">🇺🇸 English</button>
        <button class="lang-dropdown-item${lang === 'zh-tw' ? ' active' : ''}" onclick="LangManager.setLang('zh-tw')">🇹🇼 繁體中文</button>
        <button class="lang-dropdown-item${lang === 'ja' ? ' active' : ''}" onclick="LangManager.setLang('ja')">🇯🇵 日本語</button>`;
      wrap.appendChild(dd);
    }
  }
